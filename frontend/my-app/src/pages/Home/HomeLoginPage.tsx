    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="gradient-bg rounded-xl text-white p-6 mb-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold mb-2">Bienvenid@, Bea!</h1>
            <p className="text-indigo-100">
              Tienes <span className="font-bold">125 pts</span> disponibles para pedir favores
            </p>
          </div>
          <div className="flex space-x-3 mt-4 md:mt-0">
            <button className="bg-white text-indigo-600 px-6 py-2 rounded-full font-medium hover:bg-indigo-50 transition duration-200">
              <i className="fas fa-plus mr-2"></i> Pedir favor
            </button>
          </div>
        </div>
      </div>
